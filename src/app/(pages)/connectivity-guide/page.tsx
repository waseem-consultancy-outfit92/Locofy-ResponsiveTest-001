...
const MarketDataOrderFormPage = () => {
  ...
  const areas = [
    ...
    {
      id: 6,
      title: 'Directly Attached Servers Layer-2 Cross-connect/Circuits Separate Member Sites/Infrastructure Diagram Details',
    ...
    {
      id: 8,
      title: 'Directly Connected Servers and BGP Cross Connects/Circuits separate Member sites/infrastructure. Diagram Details',
