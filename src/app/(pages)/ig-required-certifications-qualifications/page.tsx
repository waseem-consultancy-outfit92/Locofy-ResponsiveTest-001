...
import {
  ...
  IGRequiredCertificationsQualificationsImage,
} from "@/assets";
...
const IGRequiredCertificationsQualificationsPage = () => {
  ...
  return (
    <>
      <Stack spacing={2} px={3} py={2}>
        ...
        <Box>
          <Image
            src={IGRequiredCertificationsQualificationsImage}
...
export default IGRequiredCertificationsQualificationsPage;
