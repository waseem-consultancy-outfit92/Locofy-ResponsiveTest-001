...
const FixProtocolTechnicalSpecification = () => {
  ...
  const areas = [
    ...
    },
    {
      id: 4,
      title:
        "New Order Single (This message is used to submit a new order to the trading platform)",
    ...
    },
    {
      id: 6,
      title:
        "Order Sweeps Order Entry (Used for orders that first go to the dark book and any remaining portion is sent to the lit order book.)",
    ...
    },
    {
      id: 8,
      title:
        "Order Cancel/Replace Request (message is used to modify an existing order (e.g., price, quantity))",
    ...
    },
    {
      id: 10,
      title:
        "Large In Scale/Benchmark Cross Trade Capture Report Acknowledgement (submission of a trade capture report)",
    ...
    },
    {
      id: 11,
      title:
        "Execution Report (message reports the execution status of an order (e.g., filled, rejected))",
    ...
    },
    {
      id: 12,
      title:
        "Order Cancel Reject (This message is sent when an order cancel or replace request cannot be processed)",
