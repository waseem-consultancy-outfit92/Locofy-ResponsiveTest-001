import { LogoImage, SequenceDiagramAqseImage } from "@/assets";
...
export default function Home() {
  ...
  const areas: ImageMapArea[] = [
    ...
    { x: 748.9458689458689, y: 770.1424501424501, width: 22.962962962963047, height: 28.262108262108313, href: '#', title: 'request final checks audio', target: '_parent' },
    { x: 770.1424501424501, y: 805.4700854700855, width: 38.86039886039896, height: 28.262108262108313, href: '#', title: 'address and follow up audio', target: '_parent' },
    { x: 775.4415954415955, y: 937.9487179487179, width: 30.028490028489955, height: 28.262108262108313, href: '#', title: 'announce official listing dates audio', target: '_parent' },
    { x: 748.9458689458689, y: 976.8091168091169, width: 35.327635327635335, height: 28.2621082621082, href: '#', title: 'begin public trading audio', target: '_parent' },
    { x: 293.2193732193732, y: 998.005698005698, width: 26.4957264957265, height: 22.962962962962933, href: '#', title: 'supports IR and compliance announcements audio', target: '_parent' },
    { x: 296.7521367521368, y: 1103.988603988604, width: 21.196581196581178, height: 26.495726495726558, href: '#', title: 'submit reports audio', target: '_parent' },
    { x: 307.35042735042737, y: 1141.082621082621, width: 26.4957264957265, height: 30.02849002849007, href: '#', title: 'monitor compliance audio', target: '_parent' },

    // Main process steps
    { x: 84.78632478632478, y: 432.76353276353274, width: 243.76068376068378, height: 24.729344729344746, href: '#', title: 'prepare financial and business plans', target: '_parent' },
    { x: 393.9031339031339, y: 443.3618233618234, width: 199.60113960113966, height: 44.15954415954411, href: '#', title: 'draft admission document', target: '_parent' },
    { x: 607.6353276353276, y: 597.0370370370371, width: 132.47863247863256, height: 22.962962962962933, href: '#', title: 'submit documents', target: '_parent' },
    { x: 575.8404558404559, y: 801.9373219373219, width: 174.8717948717948, height: 33.56125356125358, href: '#', title: 'address and follow up', target: '_parent' },
    { x: 176.63817663817665, y: 1103.988603988604, width: 111.2820512820513, height: 24.729344729344803, href: '#', title: 'submit reports', target: '_parent' },
    { x: 160.74074074074073, y: 1142.8490028490028, width: 139.54415954415956, height: 24.729344729344803, href: '#', title: 'monitor compliance', target: '_parent' }
  ];
  return (
    <Stack sx={{ px: 4, py: 5 }} spacing={4}>
      <Stack direction="row" spacing={2} alignItems="center">
        <Image src={LogoImage} alt="logo" />
        <Typography fontSize="1.5rem" fontWeight="bold" color="#5A5867">AQSE Listing Process</Typography>
      </Stack>
      <Stack direction="row" justifyContent="space-between" alignItems="center">
        <Typography fontSize="2rem" fontWeight="bold" color="#5A5867">Sequence Diagram</Typography>

        <Button variant="text" sx={{ fontWeight: "bold", fontSize: { md: "2rem", xs: "1rem" }, color: "#5A5867" }} endIcon={<ExpandCircleDownOutlinedIcon sx={{ width: { md: 40, xs: 20 }, height: { md: 40, xs: 20 } }} />}>Colour Legend</Button>
          ...
          <Link
            ...
            sx={{
              ...
              '&:hover': {
                ...
                borderRadius: area.width === area.height ? '50%' : '0', // Circular for audio buttons
                cursor: 'pointer'
              },
            }}
          />
